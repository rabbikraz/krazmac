  ...
  },
  {
    ...
    customSvg: (
      <svg viewBox="0 0 176 176" className="w-full h-full">
        <circle className="text-[#4a90e2] group-hover:text-primary transition-colors" fill="currentColor" cx="88" cy="88" r="88" />
  ...
  },
  {
    ...
    customSvg: (
      <svg className="w-full h-full" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        <path className="text-[#4a90e2] group-hover:text-primary transition-colors" fill="currentColor" d="M396,512H116C51.93,512,0,460.07,0,396V116C0,51.93,51.93,0,116,0h280c64.07,0,116,51.93,116,116v280C512,460.07,460.07,512,396,512z" />
        <g>
          ...
          <path fill="#ffffff" d="M339.46,216.33c-9.51,0-17.22,7.32-17.22,16.35v65.13c0,9.03,7.7,16.35,17.22,16.35 c9.5,0,17.22-7.32,17.22-16.35v-65.13C356.68,223.65,348.97,216.33,339.46,216.33" />
          <path fill="#ffffff" d="M394.56,249.45c-9.5,0-17.22,7.32-17.22,16.35v16.21c0,9.03,7.71,16.35,17.22,16.35 c9.51,0,17.22-7.32,17.22-16.35V265.8C411.78,256.77,404.08,249.45,394.56,249.45" />
        </g>
      </svg>
    )
  },
      ...
      {availablePlatforms.map((platform) => {
        ...
        return (
          <a
            ...
            className="flex flex-col items-center no-underline text-gray-700 hover:text-primary transition-colors hover:-translate-y-1 duration-200 group"
          >
            <div className="mb-2 w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-gray-50 rounded-full border border-gray-100 group-hover:border-primary/20 group-hover:bg-primary/5 transition-colors">
              {platform.customSvg ? (
                <div className="w-6 h-6 md:w-7 md:h-7 flex items-center justify-center">
                  {platform.customSvg}
                </div>
              ) : (
                <i className={`${platform.icon} text-[#4a90e2] text-xl md:text-2xl group-hover:text-primary transition-colors`}></i>
              )}
            </div>
            <span className="text-[10px] md:text-xs font-medium uppercase tracking-wide opacity-80 group-hover:opacity-100">{platform.label}</span>
          </a>
        )
      })}
    </div>
